    ...
    <div className="grid gap-6">
      <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
        <div>
          ...
          <h1 className="mt-1 text-2xl font-semibold tracking-tight text-slate-950">Groups</h1>
          <p className="mt-2 max-w-2xl text-sm leading-6 text-slate-600">
            Define document context, JSON output shape, API keys, and web testing in one place.
          </p>
        </div>
